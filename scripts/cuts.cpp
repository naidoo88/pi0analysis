void cuts(){
  ...
  A->Divide(6,5);
  A->cd(1);
  data->Draw("pi0im>>pairedphotonInvMass_bothPCAL_raw(150,0,0.2)",  PC1+a+PC2,"");
  A->cd(2);
  data->Draw("pi0im>>pairedphotonInvMass_bothECAL_raw(150,0,0.2)",  EC1+a+EC2,"");
  A->cd(3);
  data->Draw("pi0im>>pairedphotonInvMass_bothFCAL_raw(50,0,0.2)",   FC1+a+FC2,"");
  A->cd(4);
  data->Draw("pi0im>>pairedphotonInvMass_PCALECAL_raw(200,0,0.2)",  "(("+PC1+a+EC2+")"+o+"("+PC2+a+EC1+"))","");
  A->cd(5);
  data->Draw("pi0im>>pairedphotonInvMass_ECALFCAL_raw(50,0,0.2)",   "(("+EC1+a+FC2+")"+o+"("+EC2+a+FC1+"))","");
  A->cd(6);
  data->Draw("pi0im>>pairedphotonInvMass_PCALFCAL_raw(100,0,0.2)",  "(("+PC1+a+FC2+")"+o+"("+PC2+a+FC1+"))","");
  A->cd(7);
  data->Draw("pi0im>>pairedphotonInvMass_bothPCAL_coneL20(150,0,0.2)",  c20+a+PC1+a+PC2,"");
  A->cd(8);
  data->Draw("pi0im>>pairedphotonInvMass_bothECAL_coneL20(150,0,0.2)",  c20+a+EC1+a+EC2,"");
  A->cd(9);
  data->Draw("pi0im>>pairedphotonInvMass_bothFCAL_coneL20(100,0,0.2)",  c20+a+FC1+a+FC2,"");
  A->cd(10);
  data->Draw("pi0im>>pairedphotonInvMass_PCALECAL_coneL20(200,0,0.2)", c20+a+"(("+PC1+a+EC2+")"+o+"("+PC2+a+EC1+"))","");
  A->cd(11);
  data->Draw("pi0im>>pairedphotonInvMass_ECALFCAL_coneL20(75,0,0.2)",  c20+a+"(("+EC1+a+FC2+")"+o+"("+EC2+a+FC1+"))","");
  A->cd(12);
  data->Draw("pi0im>>pairedphotonInvMass_PCALFCAL_coneL20(75,0,0.2)",  c20+a+"(("+PC1+a+FC2+")"+o+"("+PC2+a+FC1+"))","");
  A->cd(13);
  data->Draw("pi0im>>pairedphotonInvMass_bothPCAL_coneL10(150,0,0.2)", c10+a+PC1+a+PC2,"");
  A->cd(14);
  data->Draw("pi0im>>pairedphotonInvMass_bothECAL_coneL10(150,0,0.2)", c10+a+EC1+a+EC2,"");
  A->cd(15);
  data->Draw("pi0im>>pairedphotonInvMass_bothFCAL_coneL10(100,0,0.2)", c10+a+FC1+a+FC2,"");
  A->cd(16);
  data->Draw("pi0im>>pairedphotonInvMass_PCALECAL_coneL10(200,0,0.2)", c10+a+"(("+PC1+a+EC2+")"+o+"("+PC2+a+EC1+"))","");
  A->cd(17);
  data->Draw("pi0im>>pairedphotonInvMass_ECALFCAL_coneL10(75,0,0.2)",  c10+a+"(("+EC1+a+FC2+")"+o+"("+EC2+a+FC1+"))","");
  A->cd(18);
  data->Draw("pi0im>>pairedphotonInvMass_PCALFCAL_coneL10(75,0,0.2)",  c10+a+"(("+PC1+a+FC2+")"+o+"("+PC2+a+FC1+"))","");
  A->cd(19);
  data->Draw("pi0im>>pairedphotonInvMass_bothPCAL_coneL8(150,0,0.2)", c8+a+PC1+a+PC2,"");
  A->cd(20);
  data->Draw("pi0im>>pairedphotonInvMass_bothECAL_coneL8(150,0,0.2)", c8+a+EC1+a+EC2,"");
  A->cd(21);
  data->Draw("pi0im>>pairedphotonInvMass_bothFCAL_coneL8(100,0,0.2)", c8+a+FC1+a+FC2,"");
  A->cd(22);
  data->Draw("pi0im>>pairedphotonInvMass_PCALECAL_coneL8(200,0,0.2)", c8+a+"(("+PC1+a+EC2+")"+o+"("+PC2+a+EC1+"))","");
  A->cd(23);
  data->Draw("pi0im>>pairedphotonInvMass_ECALFCAL_coneL8(75,0,0.2)",  c8+a+"(("+EC1+a+FC2+")"+o+"("+EC2+a+FC1+"))","");
  A->cd(24);
  data->Draw("pi0im>>pairedphotonInvMass_PCALFCAL_coneL8(75,0,0.2)",  c8+a+"(("+PC1+a+FC2+")"+o+"("+PC2+a+FC1+"))","");
  A->cd(25);
  data->Draw("pi0im>>pairedphotonInvMass_bothPCAL_coneL5(150,0,0.2)", c5+a+PC1+a+PC2,"");
  A->cd(26);
  data->Draw("pi0im>>pairedphotonInvMass_bothECAL_coneL5(150,0,0.2)", c5+a+EC1+a+EC2,"");
  A->cd(27);
  data->Draw("pi0im>>pairedphotonInvMass_bothFCAL_coneL5(100,0,0.2)", c5+a+FC1+a+FC2,"");
  A->cd(28);
  data->Draw("pi0im>>pairedphotonInvMass_PCALECAL_coneL5(200,0,0.2)", c5+a+"(("+PC1+a+EC2+")"+o+"("+PC2+a+EC1+"))","");
  A->cd(29);
  data->Draw("pi0im>>pairedphotonInvMass_ECALFCAL_coneL5(75,0,0.2)",  c5+a+"(("+EC1+a+FC2+")"+o+"("+EC2+a+FC1+"))","");
  A->cd(30);
  data->Draw("pi0im>>pairedphotonInvMass_PCALFCAL_coneL5(75,0,0.2)",  c5+a+"(("+PC1+a+FC2+")"+o+"("+PC2+a+FC1+"))","");
